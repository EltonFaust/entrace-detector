...
# ./demos/web/websocket-server.py --port $WEBSOCKET_PORT ---dlibFacePredictor /face-detector/data/project_dataset/features --networkModel /face-detector/data/project_dataset/aligned/cache.t7 2>&1 | tee $WEBSOCKET_LOG &
# ./demos/web/websocket-server.py --port $WEBSOCKET_PORT --networkModel /face-detector/data/project_dataset/aligned/cache.t7 2>&1 | tee $WEBSOCKET_LOG &
